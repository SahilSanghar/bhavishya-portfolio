...
return (
    <div className="grid max-sm:grid-cols-1 lg:grid-cols-2 gap-6 p-6 max-w-7xl mx-auto" id='education'>
      {/* Left Side - Image */}
    <div>
        <Image src="/Hero.webp" alt="Education" width={500} height={200} className="w-full h-[90vh]" />
    </div>
    
      {/* Right Side - Text */}
    <div className='pt-10'>
      <div className="">
        <h2 className="text-xl pb-2 flex items-center gap-3"><IoRocketSharp /> <span>Education</span></h2>
        <h3 className="text-5xl">Enlightened The <br/>Pathways</h3>
      ...
      <div className="pt-5">
        <div className="flex items-center gap-7 py-5">
          <div className="text-5xl font-extralight opacity-70"><PiGraduationCap /></div>
          <div className="">
            <h3 className="text-2xl">Masters in Machine Learning</h3>
            <p className="font-extralight opacity-70">University of Arizona, 2023 - 2025</p>
          </div>
        </div>
        <div className="flex items-center gap-7 py-5">
          <div className="text-5xl font-extralight opacity-70"><BiBookOpen /></div>
          <div className="">
            <h3 className="text-2xl">BE - Computer Science Hons</h3>
            <p className="font-extralight opacity-70">Chandigarh University, 2017 - 2021</p>
          </div>
        </div>
      </div>
      </div>
